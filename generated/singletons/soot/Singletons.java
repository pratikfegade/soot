        ...
        */
        ...
        private Global g = new Global();
            ...
            private
            soot.PhaseOptions instance_soot_PhaseOptions;
            public
            ...
            public
            soot.jimple.toolkits.callgraph.VirtualCalls soot_jimple_toolkits_callgraph_VirtualCalls() {
            if(
            ...
            private
            soot.jimple.spark.fieldrw.FieldTagger instance_soot_jimple_spark_fieldrw_FieldTagger;
            public
            soot.jimple.spark.fieldrw.FieldTagger soot_jimple_spark_fieldrw_FieldTagger() {
            if(
            ...
            public
            soot.options.Options soot_options_Options() {
            if(
            ...
            private
            soot.jimple.toolkits.callgraph.CHATransformer instance_soot_jimple_toolkits_callgraph_CHATransformer;
            public
            soot.jimple.toolkits.callgraph.CHATransformer soot_jimple_toolkits_callgraph_CHATransformer() {
            if(
            ...
            private
            soot.jimple.toolkits.typing.integer.ClassHierarchy instance_soot_jimple_toolkits_typing_integer_ClassHierarchy;
            public
            soot.jimple.toolkits.typing.integer.ClassHierarchy soot_jimple_toolkits_typing_integer_ClassHierarchy() {
            if(
            ...
            private
            soot.tagkit.TagManager instance_soot_tagkit_TagManager;
            public
            soot.tagkit.TagManager soot_tagkit_TagManager() {
            if(
            ...
            private
            soot.jimple.toolkits.pointer.representations.Environment instance_soot_jimple_toolkits_pointer_representations_Environment;
            public
            soot.jimple.toolkits.pointer.representations.Environment soot_jimple_toolkits_pointer_representations_Environment() {
            if(
            ...
            private
            soot.jimple.toolkits.pointer.representations.TypeConstants instance_soot_jimple_toolkits_pointer_representations_TypeConstants;
            public
            soot.jimple.toolkits.pointer.representations.TypeConstants soot_jimple_toolkits_pointer_representations_TypeConstants() {
            if(
            ...
            private
            soot.coffi.Util instance_soot_coffi_Util;
            public
            soot.coffi.Util soot_coffi_Util() {
            if(
            ...
            private
            soot.SourceLocator instance_soot_SourceLocator;
            public
            soot.SourceLocator soot_SourceLocator() {
            if(
            ...
            private
            soot.coffi.CONSTANT_Utf8_collector instance_soot_coffi_CONSTANT_Utf8_collector;
            public
            soot.coffi.CONSTANT_Utf8_collector soot_coffi_CONSTANT_Utf8_collector() {
            if(
            ...
            private
            soot.jimple.spark.pag.ArrayElement instance_soot_jimple_spark_pag_ArrayElement;
            public
            soot.jimple.spark.pag.ArrayElement soot_jimple_spark_pag_ArrayElement() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.tags.ArrayNullTagAggregator instance_soot_jimple_toolkits_annotation_tags_ArrayNullTagAggregator;
            public
            soot.jimple.toolkits.annotation.tags.ArrayNullTagAggregator soot_jimple_toolkits_annotation_tags_ArrayNullTagAggregator() {
            if(
            ...
            private
            soot.baf.Baf instance_soot_baf_Baf;
            public
            soot.baf.Baf soot_baf_Baf() {
            if(
            ...
            private
            soot.BooleanType instance_soot_BooleanType;
            public
            soot.BooleanType soot_BooleanType() {
            if(
            ...
            private
            soot.jimple.toolkits.scalar.pre.BusyCodeMotion instance_soot_jimple_toolkits_scalar_pre_BusyCodeMotion;
            public
            soot.jimple.toolkits.scalar.pre.BusyCodeMotion soot_jimple_toolkits_scalar_pre_BusyCodeMotion() {
            if(
            ...
            private
            soot.ByteType instance_soot_ByteType;
            public
            soot.ByteType soot_ByteType() {
            if(
            ...
            private
            soot.jimple.toolkits.pointer.CastCheckEliminatorDumper instance_soot_jimple_toolkits_pointer_CastCheckEliminatorDumper;
            public
            soot.jimple.toolkits.pointer.CastCheckEliminatorDumper soot_jimple_toolkits_pointer_CastCheckEliminatorDumper() {
            if(
            ...
            private
            soot.CharType instance_soot_CharType;
            public
            soot.CharType soot_CharType() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.arraycheck.ClassFieldAnalysis instance_soot_jimple_toolkits_annotation_arraycheck_ClassFieldAnalysis;
            public
            soot.jimple.toolkits.annotation.arraycheck.ClassFieldAnalysis soot_jimple_toolkits_annotation_arraycheck_ClassFieldAnalysis() {
            if(
            ...
            private
            soot.jimple.toolkits.scalar.CommonSubexpressionEliminator instance_soot_jimple_toolkits_scalar_CommonSubexpressionEliminator;
            public
            soot.jimple.toolkits.scalar.CommonSubexpressionEliminator soot_jimple_toolkits_scalar_CommonSubexpressionEliminator() {
            if(
            ...
            private
            soot.jimple.toolkits.scalar.ConditionalBranchFolder instance_soot_jimple_toolkits_scalar_ConditionalBranchFolder;
            public
            soot.jimple.toolkits.scalar.ConditionalBranchFolder soot_jimple_toolkits_scalar_ConditionalBranchFolder() {
            if(
            ...
            private
            soot.jimple.toolkits.scalar.ConstantPropagatorAndFolder instance_soot_jimple_toolkits_scalar_ConstantPropagatorAndFolder;
            public
            soot.jimple.toolkits.scalar.ConstantPropagatorAndFolder soot_jimple_toolkits_scalar_ConstantPropagatorAndFolder() {
            if(
            ...
            private
            soot.jimple.toolkits.graph.CriticalEdgeRemover instance_soot_jimple_toolkits_graph_CriticalEdgeRemover;
            public
            soot.jimple.toolkits.graph.CriticalEdgeRemover soot_jimple_toolkits_graph_CriticalEdgeRemover() {
            if(
            ...
            private
            soot.xml.XMLPrinter instance_soot_xml_XMLPrinter;
            public
            soot.xml.XMLPrinter soot_xml_XMLPrinter() {
            if(
            ...
            private
            soot.Printer instance_soot_Printer;
            public
            soot.Printer soot_Printer() {
            if(
            ...
            private
            soot.jimple.toolkits.scalar.DeadAssignmentEliminator instance_soot_jimple_toolkits_scalar_DeadAssignmentEliminator;
            public
            soot.jimple.toolkits.scalar.DeadAssignmentEliminator soot_jimple_toolkits_scalar_DeadAssignmentEliminator() {
            if(
            ...
            private
            soot.jimple.toolkits.pointer.DependenceTagAggregator instance_soot_jimple_toolkits_pointer_DependenceTagAggregator;
            public
            soot.jimple.toolkits.pointer.DependenceTagAggregator soot_jimple_toolkits_pointer_DependenceTagAggregator() {
            if(
            ...
            private
            soot.coffi.Double2ndHalfType instance_soot_coffi_Double2ndHalfType;
            public
            soot.coffi.Double2ndHalfType soot_coffi_Double2ndHalfType() {
            if(
            ...
            private
            soot.DoubleType instance_soot_DoubleType;
            public
            soot.DoubleType soot_DoubleType() {
            if(
            ...
            private
            soot.baf.DoubleWordType instance_soot_baf_DoubleWordType;
            public
            soot.baf.DoubleWordType soot_baf_DoubleWordType() {
            if(
            ...
            private
            soot.jimple.toolkits.pointer.DumbPointerAnalysis instance_soot_jimple_toolkits_pointer_DumbPointerAnalysis;
            public
            soot.jimple.toolkits.pointer.DumbPointerAnalysis soot_jimple_toolkits_pointer_DumbPointerAnalysis() {
            if(
            ...
            private
            soot.jimple.spark.sets.EmptyPointsToSet instance_soot_jimple_spark_sets_EmptyPointsToSet;
            public
            soot.jimple.spark.sets.EmptyPointsToSet soot_jimple_spark_sets_EmptyPointsToSet() {
            if(
            ...
            private
            soot.ErroneousType instance_soot_ErroneousType;
            public
            soot.ErroneousType soot_ErroneousType() {
            if(
            ...
            private
            soot.FloatType instance_soot_FloatType;
            public
            soot.FloatType soot_FloatType() {
            if(
            ...
            private
            soot.jimple.toolkits.pointer.FullObjectSet instance_soot_jimple_toolkits_pointer_FullObjectSet;
            public
            soot.jimple.toolkits.pointer.FullObjectSet soot_jimple_toolkits_pointer_FullObjectSet() {
            if(
            ...
            private
            soot.jimple.Jimple instance_soot_jimple_Jimple;
            public
            soot.jimple.Jimple soot_jimple_Jimple() {
            if(
            ...
            private
            soot.jimple.toolkits.scalar.pre.LazyCodeMotion instance_soot_jimple_toolkits_scalar_pre_LazyCodeMotion;
            public
            soot.jimple.toolkits.scalar.pre.LazyCodeMotion soot_jimple_toolkits_scalar_pre_LazyCodeMotion() {
            if(
            ...
            private
            soot.tagkit.LineNumberTagAggregator instance_soot_tagkit_LineNumberTagAggregator;
            public
            soot.tagkit.LineNumberTagAggregator soot_tagkit_LineNumberTagAggregator() {
            if(
            ...
            private
            soot.tagkit.InnerClassTagAggregator instance_soot_tagkit_InnerClassTagAggregator;
            public
            soot.tagkit.InnerClassTagAggregator soot_tagkit_InnerClassTagAggregator() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.LineNumberAdder instance_soot_jimple_toolkits_annotation_LineNumberAdder;
            public
            ...
            private
            soot.baf.toolkits.base.LoadStoreOptimizer instance_soot_baf_toolkits_base_LoadStoreOptimizer;
            public
            soot.baf.toolkits.base.LoadStoreOptimizer soot_baf_toolkits_base_LoadStoreOptimizer() {
            if(
            ...
            private
            soot.jimple.toolkits.scalar.LocalNameStandardizer instance_soot_jimple_toolkits_scalar_LocalNameStandardizer;
            public
            soot.jimple.toolkits.scalar.LocalNameStandardizer soot_jimple_toolkits_scalar_LocalNameStandardizer() {
            if(
            ...
            private
            soot.toolkits.scalar.LocalPacker instance_soot_toolkits_scalar_LocalPacker;
            public
            soot.toolkits.scalar.LocalPacker soot_toolkits_scalar_LocalPacker() {
            if(
            ...
            private
            soot.toolkits.scalar.LocalSplitter instance_soot_toolkits_scalar_LocalSplitter;
            public
            soot.toolkits.scalar.LocalSplitter soot_toolkits_scalar_LocalSplitter() {
            if(
            ...
            private
            soot.coffi.Long2ndHalfType instance_soot_coffi_Long2ndHalfType;
            public
            soot.coffi.Long2ndHalfType soot_coffi_Long2ndHalfType() {
            if(
            ...
            private
            soot.LongType instance_soot_LongType;
            public
            soot.LongType soot_LongType() {
            if(
            ...
            private
            soot.jimple.NullConstant instance_soot_jimple_NullConstant;
            public
            soot.jimple.NullConstant soot_jimple_NullConstant() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.nullcheck.NullPointerChecker instance_soot_jimple_toolkits_annotation_nullcheck_NullPointerChecker;
            public
            soot.jimple.toolkits.annotation.nullcheck.NullPointerChecker soot_jimple_toolkits_annotation_nullcheck_NullPointerChecker() {
            if(
            ...
            private
            soot.NullType instance_soot_NullType;
            public
            soot.NullType soot_NullType() {
            if(
            ...
            public
            soot.PackManager soot_PackManager() {
            if(
            ...
            private
            soot.baf.toolkits.base.PeepholeOptimizer instance_soot_baf_toolkits_base_PeepholeOptimizer;
            public
            soot.baf.toolkits.base.PeepholeOptimizer soot_baf_toolkits_base_PeepholeOptimizer() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.profiling.ProfilingGenerator instance_soot_jimple_toolkits_annotation_profiling_ProfilingGenerator;
            public
            soot.jimple.toolkits.annotation.profiling.ProfilingGenerator soot_jimple_toolkits_annotation_profiling_ProfilingGenerator() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.arraycheck.RectangularArrayFinder instance_soot_jimple_toolkits_annotation_arraycheck_RectangularArrayFinder;
            public
            soot.jimple.toolkits.annotation.arraycheck.RectangularArrayFinder soot_jimple_toolkits_annotation_arraycheck_RectangularArrayFinder() {
            if(
            ...
            private
            soot.RefType instance_soot_RefType;
            public
            soot.RefType soot_RefType() {
            if(
            ...
            private
            soot.Scene instance_soot_Scene;
            public
            soot.Scene soot_Scene() {
            if(
            ...
            private
            soot.shimple.Shimple instance_soot_shimple_Shimple;
            public
            soot.shimple.Shimple soot_shimple_Shimple() {
            if(
            ...
            private
            soot.shimple.ShimpleTransformer instance_soot_shimple_ShimpleTransformer;
            public
            soot.shimple.ShimpleTransformer soot_shimple_ShimpleTransformer() {
            if(
            ...
            private
            soot.shimple.toolkits.scalar.SConstantPropagatorAndFolder instance_soot_shimple_toolkits_scalar_SConstantPropagatorAndFolder;
            public
            ...
            private
            soot.ShortType instance_soot_ShortType;
            public
            soot.ShortType soot_ShortType() {
            if(
            ...
            private
            soot.jimple.toolkits.pointer.SideEffectTagger instance_soot_jimple_toolkits_pointer_SideEffectTagger;
            public
            soot.jimple.toolkits.pointer.SideEffectTagger soot_jimple_toolkits_pointer_SideEffectTagger() {
            if(
            ...
            private
            soot.jimple.spark.SparkTransformer instance_soot_jimple_spark_SparkTransformer;
            public
            soot.jimple.spark.SparkTransformer soot_jimple_spark_SparkTransformer() {
            if(
            ...
            private
            soot.jimple.toolkits.invoke.StaticInliner instance_soot_jimple_toolkits_invoke_StaticInliner;
            public
            soot.jimple.toolkits.invoke.StaticInliner soot_jimple_toolkits_invoke_StaticInliner() {
            if(
            ...
            private
            soot.jimple.toolkits.invoke.StaticMethodBinder instance_soot_jimple_toolkits_invoke_StaticMethodBinder;
            public
            soot.jimple.toolkits.invoke.StaticMethodBinder soot_jimple_toolkits_invoke_StaticMethodBinder() {
            if(
            ...
            private
            soot.StmtAddressType instance_soot_StmtAddressType;
            public
            soot.StmtAddressType soot_StmtAddressType() {
            if(
            ...
            private
            soot.jimple.toolkits.typing.TypeAssigner instance_soot_jimple_toolkits_typing_TypeAssigner;
            public
            soot.jimple.toolkits.typing.TypeAssigner soot_jimple_toolkits_typing_TypeAssigner() {
            if(
            ...
            private
            soot.jimple.toolkits.scalar.UnconditionalBranchFolder instance_soot_jimple_toolkits_scalar_UnconditionalBranchFolder;
            public
            soot.jimple.toolkits.scalar.UnconditionalBranchFolder soot_jimple_toolkits_scalar_UnconditionalBranchFolder() {
            if(
            ...
            private
            soot.jimple.toolkits.scalar.ConstantCastEliminator instance_soot_jimple_toolkits_scalar_ConstantCastEliminator;
            public
            soot.jimple.toolkits.scalar.ConstantCastEliminator soot_jimple_toolkits_scalar_ConstantCastEliminator() {
            if(
            ...
            private
            soot.UnknownType instance_soot_UnknownType;
            public
            soot.UnknownType soot_UnknownType() {
            if(
            ...
            private
            soot.jimple.toolkits.scalar.UnreachableCodeEliminator instance_soot_jimple_toolkits_scalar_UnreachableCodeEliminator;
            public
            soot.jimple.toolkits.scalar.UnreachableCodeEliminator soot_jimple_toolkits_scalar_UnreachableCodeEliminator() {
            if(
            ...
            private
            soot.toolkits.scalar.UnusedLocalEliminator instance_soot_toolkits_scalar_UnusedLocalEliminator;
            public
            soot.toolkits.scalar.UnusedLocalEliminator soot_toolkits_scalar_UnusedLocalEliminator() {
            if(
            ...
            private
            soot.coffi.UnusuableType instance_soot_coffi_UnusuableType;
            public
            soot.coffi.UnusuableType soot_coffi_UnusuableType() {
            if(
            ...
            private
            soot.VoidType instance_soot_VoidType;
            public
            soot.VoidType soot_VoidType() {
            if(
            ...
            private
            soot.baf.WordType instance_soot_baf_WordType;
            public
            soot.baf.WordType soot_baf_WordType() {
            if(
            ...
            private
            soot.jimple.spark.fieldrw.FieldReadTagAggregator instance_soot_jimple_spark_fieldrw_FieldReadTagAggregator;
            public
            soot.jimple.spark.fieldrw.FieldReadTagAggregator soot_jimple_spark_fieldrw_FieldReadTagAggregator() {
            if(
            ...
            private
            soot.jimple.spark.fieldrw.FieldWriteTagAggregator instance_soot_jimple_spark_fieldrw_FieldWriteTagAggregator;
            public
            soot.jimple.spark.fieldrw.FieldWriteTagAggregator soot_jimple_spark_fieldrw_FieldWriteTagAggregator() {
            if(
            ...
            private
            soot.jimple.spark.fieldrw.FieldTagAggregator instance_soot_jimple_spark_fieldrw_FieldTagAggregator;
            public
            soot.jimple.spark.fieldrw.FieldTagAggregator soot_jimple_spark_fieldrw_FieldTagAggregator() {
            if(
            ...
            private
            soot.EntryPoints instance_soot_EntryPoints;
            public
            soot.EntryPoints soot_EntryPoints() {
            if(
            ...
            public
            soot.jimple.toolkits.annotation.callgraph.CallGraphTagger soot_jimple_toolkits_annotation_callgraph_CallGraphTagger() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.nullcheck.NullPointerColorer instance_soot_jimple_toolkits_annotation_nullcheck_NullPointerColorer;
            public
            soot.jimple.toolkits.annotation.nullcheck.NullPointerColorer soot_jimple_toolkits_annotation_nullcheck_NullPointerColorer() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.parity.ParityTagger instance_soot_jimple_toolkits_annotation_parity_ParityTagger;
            public
            soot.jimple.toolkits.annotation.parity.ParityTagger soot_jimple_toolkits_annotation_parity_ParityTagger() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.methods.UnreachableMethodsTagger instance_soot_jimple_toolkits_annotation_methods_UnreachableMethodsTagger;
            public
            soot.jimple.toolkits.annotation.methods.UnreachableMethodsTagger soot_jimple_toolkits_annotation_methods_UnreachableMethodsTagger() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.fields.UnreachableFieldsTagger instance_soot_jimple_toolkits_annotation_fields_UnreachableFieldsTagger;
            public
            soot.jimple.toolkits.annotation.fields.UnreachableFieldsTagger soot_jimple_toolkits_annotation_fields_UnreachableFieldsTagger() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.qualifiers.TightestQualifiersTagger instance_soot_jimple_toolkits_annotation_qualifiers_TightestQualifiersTagger;
            public
            soot.jimple.toolkits.annotation.qualifiers.TightestQualifiersTagger soot_jimple_toolkits_annotation_qualifiers_TightestQualifiersTagger() {
            if(
            ...
            private
            soot.jimple.toolkits.pointer.ParameterAliasTagger instance_soot_jimple_toolkits_pointer_ParameterAliasTagger;
            public
            soot.jimple.toolkits.pointer.ParameterAliasTagger soot_jimple_toolkits_pointer_ParameterAliasTagger() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.defs.ReachingDefsTagger instance_soot_jimple_toolkits_annotation_defs_ReachingDefsTagger;
            public
            soot.jimple.toolkits.annotation.defs.ReachingDefsTagger soot_jimple_toolkits_annotation_defs_ReachingDefsTagger() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.liveness.LiveVarsTagger instance_soot_jimple_toolkits_annotation_liveness_LiveVarsTagger;
            public
            soot.jimple.toolkits.annotation.liveness.LiveVarsTagger soot_jimple_toolkits_annotation_liveness_LiveVarsTagger() {
            if(
            ...
            private
            soot.toolkits.graph.interaction.InteractionHandler instance_soot_toolkits_graph_interaction_InteractionHandler;
            public
            soot.toolkits.graph.interaction.InteractionHandler soot_toolkits_graph_interaction_InteractionHandler() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.logic.LoopInvariantFinder instance_soot_jimple_toolkits_annotation_logic_LoopInvariantFinder;
            public
            soot.jimple.toolkits.annotation.logic.LoopInvariantFinder soot_jimple_toolkits_annotation_logic_LoopInvariantFinder() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.AvailExprTagger instance_soot_jimple_toolkits_annotation_AvailExprTagger;
            public
            soot.jimple.toolkits.annotation.AvailExprTagger soot_jimple_toolkits_annotation_AvailExprTagger() {
            if(
            ...
            private
            soot.util.PhaseDumper instance_soot_util_PhaseDumper;
            public
            soot.util.PhaseDumper soot_util_PhaseDumper() {
            if(
            ...
            private
            soot.util.cfgcmd.AltClassLoader instance_soot_util_cfgcmd_AltClassLoader;
            public
            soot.util.cfgcmd.AltClassLoader soot_util_cfgcmd_AltClassLoader() {
            if(
            ...
            private
            soot.toolkits.exceptions.ThrowableSet.Manager instance_soot_toolkits_exceptions_ThrowableSet_Manager;
            public
            soot.toolkits.exceptions.ThrowableSet.Manager soot_toolkits_exceptions_ThrowableSet_Manager() {
            if(
            ...
            private
            soot.toolkits.exceptions.UnitThrowAnalysis instance_soot_toolkits_exceptions_UnitThrowAnalysis;
            public
            soot.toolkits.exceptions.UnitThrowAnalysis soot_toolkits_exceptions_UnitThrowAnalysis() {
            if(
            ...
            private
            soot.dexpler.DalvikThrowAnalysis instance_soot_dexpler_DalvikThrowAnalysis;
            public
            soot.dexpler.DalvikThrowAnalysis soot_dexpler_DalvikThrowAnalysis() {
            if(
            ...
            private
            soot.toolkits.exceptions.PedanticThrowAnalysis instance_soot_toolkits_exceptions_PedanticThrowAnalysis;
            public
            soot.toolkits.exceptions.PedanticThrowAnalysis soot_toolkits_exceptions_PedanticThrowAnalysis() {
            if(
            ...
            private
            soot.toolkits.exceptions.TrapTightener instance_soot_toolkits_exceptions_TrapTightener;
            public
            soot.toolkits.exceptions.TrapTightener soot_toolkits_exceptions_TrapTightener() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.callgraph.CallGraphGrapher instance_soot_jimple_toolkits_annotation_callgraph_CallGraphGrapher;
            public
            soot.jimple.toolkits.annotation.callgraph.CallGraphGrapher soot_jimple_toolkits_annotation_callgraph_CallGraphGrapher() {
            if(
            ...
            private
            soot.SootResolver instance_soot_SootResolver;
            public
            soot.SootResolver soot_SootResolver() {
            if(
            ...
            private
            soot.javaToJimple.InitialResolver instance_soot_javaToJimple_InitialResolver;
            public
            ...
            private
            soot.jimple.toolkits.annotation.DominatorsTagger instance_soot_jimple_toolkits_annotation_DominatorsTagger;
            public
            soot.jimple.toolkits.annotation.DominatorsTagger soot_jimple_toolkits_annotation_DominatorsTagger() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.purity.PurityAnalysis instance_soot_jimple_toolkits_annotation_purity_PurityAnalysis;
            public
            soot.jimple.toolkits.annotation.purity.PurityAnalysis soot_jimple_toolkits_annotation_purity_PurityAnalysis() {
            if(
            ...
            private
            soot.javaToJimple.toolkits.CondTransformer instance_soot_javaToJimple_toolkits_CondTransformer;
            public
            soot.javaToJimple.toolkits.CondTransformer soot_javaToJimple_toolkits_CondTransformer() {
            if(
            ...
            private
            soot.jimple.spark.sets.AllSharedListNodes instance_soot_jimple_spark_sets_AllSharedListNodes;
            public
            soot.jimple.spark.sets.AllSharedListNodes soot_jimple_spark_sets_AllSharedListNodes() {
            if(
            ...
            private
            soot.jimple.spark.sets.AllSharedHybridNodes instance_soot_jimple_spark_sets_AllSharedHybridNodes;
            public
            soot.jimple.spark.sets.AllSharedHybridNodes soot_jimple_spark_sets_AllSharedHybridNodes() {
            if(
            ...
            private
            soot.jimple.toolkits.thread.synchronization.LockAllocator instance_soot_jimple_toolkits_thread_synchronization_LockAllocator;
            public
            soot.jimple.toolkits.thread.synchronization.LockAllocator soot_jimple_toolkits_thread_synchronization_LockAllocator() {
            if(
            ...
            private
            soot.jimple.toolkits.thread.mhp.MhpTransformer instance_soot_jimple_toolkits_thread_mhp_MhpTransformer;
            public
            soot.jimple.toolkits.thread.mhp.MhpTransformer soot_jimple_toolkits_thread_mhp_MhpTransformer() {
            if(
            ...
            private
            soot.JastAddInitialResolver instance_soot_JastAddInitialResolver;
            public
            soot.JastAddInitialResolver soot_JastAddInitialResolver() {
            if(
            ...
            private
            soot.jimple.toolkits.annotation.j5anno.AnnotationGenerator instance_soot_jimple_toolkits_annotation_j5anno_AnnotationGenerator;
            public
            soot.jimple.toolkits.annotation.j5anno.AnnotationGenerator soot_jimple_toolkits_annotation_j5anno_AnnotationGenerator() {
            if(
            ...
            private
            soot.sootify.TemplatePrinter instance_soot_sootify_TemplatePrinter;
            public
            soot.sootify.TemplatePrinter soot_sootify_TemplatePrinter() {
            if(
            ...
            private
            soot.dexpler.DexResolver instance_soot_dexpler_DexResolver;
            public
            soot.dexpler.DexResolver soot_dexpler_DexResolver() {
            if(
            ...
            private
            soot.jimple.toolkits.scalar.EmptySwitchEliminator instance_soot_jimple_toolkits_scalar_EmptySwitchEliminator;
            public
            soot.jimple.toolkits.scalar.EmptySwitchEliminator soot_jimple_toolkits_scalar_EmptySwitchEliminator() {
            if(
            ...
            private
            soot.toDex.SynchronizedMethodTransformer instance_soot_toDex_SynchronizedMethodTransformer;
            public
            soot.toDex.SynchronizedMethodTransformer soot_toDex_SynchronizedMethodTransformer() {
            if(
            ...
            private
            soot.toDex.TrapSplitter instance_soot_toDex_TrapSplitter;
            public
            soot.toDex.TrapSplitter soot_toDex_TrapSplitter() {
            if(
            ...
            private
            soot.toDex.FastDexTrapTightener instance_soot_toDex_FastDexTrapTightener;
            public
            soot.toDex.FastDexTrapTightener soot_toDex_FastDexTrapTightener() {
            if(
            ...
            private
            soot.jimple.toolkits.base.RenameDuplicatedClasses instance_soot_jimple_toolkits_base_RenameDuplicatedClasses;
            public
            soot.jimple.toolkits.base.RenameDuplicatedClasses soot_jimple_toolkits_base_RenameDuplicatedClasses() {
            if(
            ...
            private
            soot.jimple.toolkits.typing.fast.Integer127Type instance_soot_jimple_toolkits_typing_fast_Integer127Type;
            public
            soot.jimple.toolkits.typing.fast.Integer127Type soot_jimple_toolkits_typing_fast_Integer127Type() {
            if(
            ...
            private
            soot.jimple.toolkits.typing.fast.Integer1Type instance_soot_jimple_toolkits_typing_fast_Integer1Type;
            public
            soot.jimple.toolkits.typing.fast.Integer1Type soot_jimple_toolkits_typing_fast_Integer1Type() {
            if(
            ...
            private
            soot.jimple.toolkits.typing.fast.Integer32767Type instance_soot_jimple_toolkits_typing_fast_Integer32767Type;
            public
            soot.jimple.toolkits.typing.fast.Integer32767Type soot_jimple_toolkits_typing_fast_Integer32767Type() {
            if(
            ...
            private
            soot.jimple.toolkits.typing.fast.BottomType instance_soot_jimple_toolkits_typing_fast_BottomType;
            public
            soot.jimple.toolkits.typing.fast.BottomType soot_jimple_toolkits_typing_fast_BottomType() {
            if(
            ...
            private
            soot.dexpler.TrapMinimizer instance_soot_dexpler_TrapMinimizer;
            public
            soot.dexpler.TrapMinimizer soot_dexpler_TrapMinimizer() {
            if(
            ...
            private
            soot.toolkits.scalar.SmartLocalDefsPool instance_soot_toolkits_scalar_SmartLocalDefsPool;
            public
            soot.toolkits.scalar.SmartLocalDefsPool soot_toolkits_scalar_SmartLocalDefsPool() {
            if(
