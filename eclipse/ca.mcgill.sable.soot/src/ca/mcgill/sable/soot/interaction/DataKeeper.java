...
import soot.toolkits.graph.interaction.IInteractionConstants;
...
public class DataKeeper {
    ...
    public boolean inMiddle() {
        ...
        return getFlowInfoList().indexOf(getCurrent()) != getFlowInfoList().size() - 1;
    }
    ...
    public boolean canGoBack() {
        ...
        return !getCurrent().equals(getFlowInfoList().get(0));
