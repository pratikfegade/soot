    ...
    <xsl:template match="/singletons">
        ...
        */
        ...
        <xsl:for-each select="/singletons/class">
            ...
            <xsl:variable name="instanceName">instance_<xsl:value-of select="$undottedClass"/>
            </xsl:variable>
            private
            <xsl:value-of select="$class"/><xsl:text> </xsl:text><xsl:value-of select="$instanceName"/>;
            public
            <xsl:value-of select="$class"/><xsl:text> </xsl:text><xsl:value-of select="$undottedClass"/>() {
            if(
