...
public final class ThrowableSet {
     ...
     *
     * @param include The set of {@link RefType} and {@link AnySubType} objects
     *                representing the types to be included in the set.
     * @param exclude The set of {@link AnySubType} objects representing the types
     ...
     *
     * @param e represents a subtree of the exception class hierarchy to add
     *          to this set.
     * @return a set containing <code>e</code> and all its subclasses, as well
     * as the exceptions represented by this set.
     * @throws ThrowableSet.AlreadyHasExclusionsException if this <code>ThrowableSet</code> is the result of a
     ...
     * @throws ThrowableSet.AlreadyHasExclusionsException if this <code>ThrowableSet</code> or <code>s</code> is the
     ...
     *
     * @param addedExceptions a set of {@link RefLikeType} and {@link AnySubType} objects to
    ...
    public static class Manager {
         ...
         * @param exclude A set of {@link AnySubType} objects representing exception
