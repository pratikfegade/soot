...
public abstract class BlockGraph implements DirectedGraph<Block> {
     ...
     * {@link UnitGraph}.
     *
     * @param unitGraph A representation of the control flow at the level of
     ...
     * </p>
     *
     * @param unitGraph is the <code>Unit</code>-level CFG which is to be split into
     *                  basic blocks.
     ...
     * @param unitGraph Provides information about the predecessors and successors of
     ...
     * @param unitToBlock A map from units to blocks. <code>addBlock()</code> will add
