...
public class ExceptionalUnitGraph extends UnitGraph implements
     ...
     * @param throwAnalysis          the source of information about the exceptions which each
     *                               {@link Unit} may throw.
     ...
     *
     * @param body                  the <code>Body</code> from which to build a graph.
     * @param ignoredBogusParameter a meaningless placeholder, which exists solely to distinguish
     ...
     * </p>
     *
     * @param throwAnalysis The source of information about which exceptions each
     ...
     * @param caught The set of exception types thrown by <code>u</code> which are
     ...
     * @param throwAnalysis          the source of information about the exceptions which each
     *                               {@link Unit} may throw.
     * @param unitToExceptionDests   A <code>Map</code> from {@link Unit}s to {@link Collection}s
     ...
     * @param unitToSuccs            A <code>Map</code> from <code>Unit</code>s to {@link List}s of
     ...
     * @param omitExceptingUnitEdges Indicates whether to omit exceptional edges from excepting
