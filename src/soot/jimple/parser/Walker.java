...
public class Walker extends DepthFirstAdapter {
    ...
    public void outAVoidType(AVoidType node) {
        mProductions.addLast(new VoidType());
    }
    ...
    public void inAFullMethodBody(AFullMethodBody node) {
        mLocals = new ConcurrentHashMap<>();
        mLabelToStmtMap = new ConcurrentHashMap<>();
        mLabelToPatchList = new ConcurrentHashMap<>();
    }

    public void outAFullMethodBody(AFullMethodBody node) {
        JimpleBody jBody = Jimple.newBody();
    ...
    public void outADeclaration(ADeclaration node) {
        ...
        while (it.hasNext()) {
            Local l = Jimple.newLocal((String) it.next(), type);
    ...
    public void outAUnknownJimpleType(AUnknownJimpleType node) {
        mProductions.addLast(UnknownType.getInstance());
    }
    ...
    public void outABreakpointStatement(ABreakpointStatement node) {
        Unit u = Jimple.newBreakpointStmt();
    ...
    public void outAEntermonitorStatement(AEntermonitorStatement node) {
        ...
        Unit u = Jimple.newEnterMonitorStmt(op);
        mProductions.addLast(u);
    }
    ...
    public void outAExitmonitorStatement(AExitmonitorStatement node) {
        ...
        Unit u = Jimple.newExitMonitorStmt(op);
        mProductions.addLast(u);
    }
    ...
    public void outATableswitchStatement(ATableswitchStatement node) {
        ...
        Unit switchStmt = Jimple.newTableSwitchStmt(key, lowIndex,
    ...
    public void outALookupswitchStatement(ALookupswitchStatement node) {
        ...
        Value key = (Value) mProductions.removeLast();
        Unit switchStmt = Jimple.newLookupSwitchStmt(key, lookupValues,
    ...
    public void outAIdentityNoTypeStatement(AIdentityNoTypeStatement node) {
        ...
        Unit u = Jimple.newIdentityStmt(local,
    ...
    public void outAAssignStatement(AAssignStatement node) {
        ...
        Unit u = Jimple.newAssignStmt(variable, rvalue);
        mProductions.addLast(u);
    }
    ...
    public void outAIfStatement(AIfStatement node) {
        ...
        UnitBox box = Jimple.newStmtBox(null);
        Unit u = Jimple.newIfStmt(condition, box);
    ...
    public void outAReturnStatement(AReturnStatement node) {
        ...
        if (node.getImmediate() != null) {
            ...
            s = Jimple.newReturnStmt(v);
        } else {
            s = Jimple.newReturnVoidStmt();
        }
    ...
    public void outAGotoStatement(AGotoStatement node) {
        ...
        UnitBox box = Jimple.newStmtBox(null);
        Unit branch = Jimple.newGotoStmt(box);
    ...
    public void outAInvokeStatement(AInvokeStatement node) {
        ...
        Unit u = Jimple.newInvokeStmt(op);
    ...
    public void outAStringConstant(AStringConstant node) {
		 ...
		 * 
		 * mProductions.push(StringConstant.getInstance(t)); } catch(RuntimeException e) {
		 * G.getInstance().out.println(s); throw e; }
		 */
    }
    ...
    public void outAAndBinop(AAndBinop node) {
        mProductions.addLast(Jimple.newAndExpr(mValue, mValue));
    }

    public void outAOrBinop(AOrBinop node) {
        mProductions.addLast(Jimple.newOrExpr(mValue, mValue));
    }

    public void outAXorBinop(AXorBinop node) {
        mProductions.addLast(Jimple.newXorExpr(mValue, mValue));
    }

    public void outAModBinop(AModBinop node) {
        mProductions.addLast(Jimple.newRemExpr(mValue, mValue));
    }

    public void outACmpBinop(ACmpBinop node) {
        mProductions.addLast(Jimple.newCmpExpr(mValue, mValue));
    }

    public void outACmpgBinop(ACmpgBinop node) {
        mProductions.addLast(Jimple.newCmpgExpr(mValue, mValue));
    }

    public void outACmplBinop(ACmplBinop node) {
        mProductions.addLast(Jimple.newCmplExpr(mValue, mValue));
    }

    public void outACmpeqBinop(ACmpeqBinop node) {
        mProductions.addLast(Jimple.newEqExpr(mValue, mValue));
    }

    public void outACmpneBinop(ACmpneBinop node) {
        mProductions.addLast(Jimple.newNeExpr(mValue, mValue));
    }

    public void outACmpgtBinop(ACmpgtBinop node) {
        mProductions.addLast(Jimple.newGtExpr(mValue, mValue));
    }

    public void outACmpgeBinop(ACmpgeBinop node) {
        mProductions.addLast(Jimple.newGeExpr(mValue, mValue));
    }

    public void outACmpltBinop(ACmpltBinop node) {
        mProductions.addLast(Jimple.newLtExpr(mValue, mValue));
    }

    public void outACmpleBinop(ACmpleBinop node) {
        mProductions.addLast(Jimple.newLeExpr(mValue, mValue));
    }

    public void outAShlBinop(AShlBinop node) {
        mProductions.addLast(Jimple.newShlExpr(mValue, mValue));
    }

    public void outAShrBinop(AShrBinop node) {
        mProductions.addLast(Jimple.newShrExpr(mValue, mValue));
    }

    public void outAUshrBinop(AUshrBinop node) {
        mProductions.addLast(Jimple.newUshrExpr(mValue, mValue));
    }

    public void outAPlusBinop(APlusBinop node) {
        mProductions.addLast(Jimple.newAddExpr(mValue, mValue));
    }

    public void outAMinusBinop(AMinusBinop node) {
        mProductions.addLast(Jimple.newSubExpr(mValue, mValue));
    }

    public void outAMultBinop(AMultBinop node) {
        mProductions.addLast(Jimple.newMulExpr(mValue, mValue));
    }

    public void outADivBinop(ADivBinop node) {
        mProductions.addLast(Jimple.newDivExpr(mValue, mValue));
    }
    ...
    public void outAArrayReference(AArrayReference node) {
        ...
        mProductions.addLast(Jimple.newArrayRef(l, immediate));
    ...
    public void outALocalFieldRef(ALocalFieldRef node) {
        ...
        mProductions.addLast(Jimple.newInstanceFieldRef(l, field));
    }
    ...
    public void outALengthofUnop(ALengthofUnop node) {
        mProductions.addLast(Jimple.newLengthExpr(mValue));
    }

    public void outANegUnop(ANegUnop node) {
        mProductions.addLast(Jimple.newNegExpr(mValue));
    }
    ...
    public void outANonstaticInvokeExpr(ANonstaticInvokeExpr node) {
        ...
        if (invokeType instanceof ASpecialNonstaticInvoke) {
            ...
            invokeExpr = Jimple.newInterfaceInvokeExpr(l, method, args);
        }
    ...
    public void outAStaticInvokeExpr(AStaticInvokeExpr node) {
        ...
        mProductions.addLast(Jimple.newStaticInvokeExpr(method, args));
    }
    ...
    public void outADynamicInvokeExpr(ADynamicInvokeExpr node) {
        ...
        mProductions.addLast(Jimple.newDynamicInvokeExpr(bsmMethodRef,
    ...
    public void outASimpleNewExpr(ASimpleNewExpr node) {
        mProductions.addLast(Jimple.newNewExpr(
    ...
    public void outAArrayNewExpr(AArrayNewExpr node) {
        ...
        Type type = (Type) mProductions.removeLast();
        mProductions.addLast(Jimple.newNewArrayExpr(type, size));
    }
    ...
    public void outAMultiNewExpr(AMultiNewExpr node) {
        ...
        Type type = (Type) mProductions.removeLast();
        ArrayType arrayType = ArrayType.getInstance(type, descCnt);

        mProductions.addLast(Jimple.newNewMultiArrayExpr(arrayType, sizes));
    }
