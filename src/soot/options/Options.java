...
public class Options extends OptionsBase {
    ...
    private static final int java_version_1 = 2;
    private static final int java_version_2 = 3;
    private static final int java_version_3 = 4;
    private static final int java_version_4 = 5;
    private static final int java_version_5 = 6;
    private static final int java_version_6 = 7;
    private static final int java_version_7 = 8;
    private static final int java_version_8 = 9;
    public static final int wrong_staticness_fail = 1;
    private static final int wrong_staticness_ignore = 2;
    ...
    private static final int check_init_throw_analysis_auto = 1;
    private static final int check_init_throw_analysis_pedantic = 2;
        ...
        while( hasMoreOptions() ) {
            ...
            if( false );
                ...
                if( android_jars.length() == 0 )
                    ...
                    System.out.println( "Duplicate values "+android_jars+" and "+value+" for option -"+option );
                    return false;
                }
            }
                ...
                if( force_android_jar.length() == 0 )
                    ...
                    System.out.println( "Duplicate values "+force_android_jar+" and "+value+" for option -"+option );
                    return false;
                }
            }
                ...
                if( android_api_version == -1 )
                    ...
                    System.out.println( "Duplicate values "+android_api_version+" and "+value+" for option -"+option );
                    return false;
                }
            }
                ...
                if( main_class.length() == 0 )
                    ...
                    System.out.println( "Duplicate values "+main_class+" and "+value+" for option -"+option );
                    return false;
                }
            }
