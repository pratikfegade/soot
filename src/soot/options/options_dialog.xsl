    ...
    <xsl:template match="options">
        ...
        */
        ...
        <xsl:for-each select="section">
            Composite <xsl:value-of select="translate(name[last()],'-. ','___')"/>Child = <xsl:value-of
                select="translate(name[last()],'-. ','___')"/>Create(getPageContainer());
        </xsl:for-each>
        }
        ...
        */
        ...
        <xsl:for-each select="section">
            ...
            <xsl:for-each select="boolopt">
                settings.put(get<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget().getAlias(),
                get<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget().getButton().getSelection());
            </xsl:for-each>
            ...
            <xsl:for-each select="listopt">
                settings.put(get<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget().getAlias(),
                get<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget().getText().getText());
            </xsl:for-each>
            ...
            <xsl:for-each select="multiopt">
                settings.put(get<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget().getAlias(),
                get<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget().getSelectedAlias());
            </xsl:for-each>
        ...
        */
        ...
        <xsl:for-each select="section">
            ...
            SootOption("<xsl:value-of select="name"/>");
        ...
        */
        <xsl:for-each select="section">
            ...
            <xsl:for-each select="boolopt">
                ...
                private void set<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget(BooleanOptionWidget
                widget) {
            ...
            <xsl:for-each select="listopt">
                ...
                private void set<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget(PathOptionWidget
                widget) {
                <xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget = widget;
                }
            ...
            <xsl:for-each select="stropt">
                ...
                private void set<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget(StringOptionWidget
                widget) {
                <xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget = widget;
                }
            ...
            <xsl:for-each select="multiopt">
                ...
                private void set<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget(MultiOptionWidget
                widget) {
                <xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget = widget;
                }
            ...
            <xsl:for-each select="boolopt">
                set<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget(new
                BooleanOptionWidget(editGroup, SWT.NONE, new OptionData("<xsl:value-of select="name"/>", "<xsl:value-of
                    select="alias"/>", "<xsl:apply-templates select="short_desc"/>")));
            </xsl:for-each>
            ...
            <xsl:for-each select="multiopt">
                ...
                set<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget(new MultiOptionWidget(editGroup,
                SWT.NONE, data, new OptionData("<xsl:value-of select="name"/>", "<xsl:value-of select="alias"/>", "
                <xsl:apply-templates select="short_desc"/>")));
            </xsl:for-each>

            <xsl:for-each select="listopt">
                set<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget(new PathOptionWidget(editGroup,
                SWT.NONE, new OptionData("<xsl:value-of select="name"/>", "<xsl:value-of select="alias"/>", "
                <xsl:apply-templates select="short_desc"/>")));
            </xsl:for-each>

            <xsl:for-each select="stropt">
                set<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget(new
                StringOptionWidget(editGroup, SWT.NONE, new OptionData("<xsl:value-of select="name"/>", "<xsl:value-of
                    select="alias"/>", "<xsl:apply-templates select="short_desc"/>")));
            </xsl:for-each>
