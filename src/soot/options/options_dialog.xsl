    ...
    <xsl:template match="options">
        ...
        */
        ...
        <xsl:for-each select="section">
            ...
            <xsl:for-each select="boolopt">
                settings.put(get<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget().getAlias(), get<xsl:value-of
        ...
        */
        <xsl:for-each select="section">
            ...
            <xsl:for-each select="boolopt">
                set<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget(new BooleanOptionWidget(editGroup, SWT.NONE, new
                OptionData("<xsl:value-of select="name"/>", "<xsl:value-of select="alias"/>", "<xsl:apply-templates select="short_desc"/>
                ")));
            </xsl:for-each>
            ...
            <xsl:for-each select="multiopt">
                ...
                set<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget(new MultiOptionWidget(editGroup, SWT.NONE, data, new
                OptionData("<xsl:value-of select="name"/>", "<xsl:value-of select="alias"/>", "<xsl:apply-templates select="short_desc"/>
                ")));
            </xsl:for-each>

            <xsl:for-each select="listopt">
                set<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget(new PathOptionWidget(editGroup, SWT.NONE, new
                OptionData("<xsl:value-of select="name"/>", "<xsl:value-of select="alias"/>", "<xsl:apply-templates select="short_desc"/>
                ")));
            </xsl:for-each>

            <xsl:for-each select="stropt">
                set<xsl:value-of select="translate(alias[last()],'-. ','___')"/>_widget(new StringOptionWidget(editGroup, SWT.NONE, new
                OptionData("<xsl:value-of select="name"/>", "<xsl:value-of select="alias"/>", "<xsl:apply-templates select="short_desc"/>
                ")));
            </xsl:for-each>
