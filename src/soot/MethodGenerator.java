...
public class MethodGenerator implements Runnable {
    ...
    public void generate(SootMethod m, Body b, Session session) {
        ...
        try {
            if (!m.getDeclaration().equals("<org.apache.xalan.processor.TransformerFactoryImpl: void <clinit>()>") &&
                    !m.getDeclaration().equals("<sun.net.www.MimeEntry: java.lang.Object launch(java.net.URLConnection,java.io.InputStream,sun.net.www.MimeTable)>") &&
                    !m.getDeclaration().equals("public java.lang.Object launch(java.net.URLConnection, java.io.InputStream, sun.net.www.MimeTable) throws sun.net.www.ApplicationLaunchException") &&
                    !m.getDeclaration().equals("<org.apache.xalan.lib.sql.SQLDocument: boolean nextNode()>"))
                b.validate();
        } catch (Exception ex) {
