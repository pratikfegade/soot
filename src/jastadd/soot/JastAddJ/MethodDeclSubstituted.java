...
public class MethodDeclSubstituted extends MethodDecl implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public MethodDeclSubstituted fullCopy() {
        MethodDeclSubstituted res = copy();
  ...
  public void transformation() { }
    ...
    // Declared in Generics.ast line 27
    public MethodDeclSubstituted(Modifiers p0, Access p1, jastadd.beaver.Symbol p2, List<ParameterDeclaration> p3, List<Access> p4, Opt<Block> p5, MethodDecl p6) {
        setChild(p0, 0);
        setChild(p1, 1);
        setID(p2);
        setChild(p3, 2);
