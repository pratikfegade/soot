...
public class ConstructorDeclSubstituted extends ConstructorDecl implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public ConstructorDeclSubstituted fullCopy() {
        ConstructorDeclSubstituted res = copy();
  ...
  protected TypeDecl createAnonymousJavaTypeDecl() {
    ...
    // Declared in Generics.ast line 28
    public ConstructorDeclSubstituted(Modifiers p0, jastadd.beaver.Symbol p1, List<ParameterDeclaration> p2, List<Access> p3, Opt<Stmt> p4, Block p5, ConstructorDecl p6) {
        setChild(p0, 0);
        setID(p1);
        setChild(p2, 1);
        setChild(p3, 2);
