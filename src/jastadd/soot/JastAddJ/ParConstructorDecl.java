...
public class ParConstructorDecl extends ConstructorDecl implements Cloneable {
    ...
    // Declared in GenericMethods.ast line 7
    public ParConstructorDecl(Modifiers p0, jastadd.beaver.Symbol p1, List<ParameterDeclaration> p2, List<Access> p3, Opt<Stmt> p4, Block p5, List<Access> p6) {
        setChild(p0, 0);
        setID(p1);
        setChild(p2, 1);
        setChild(p3, 2);
