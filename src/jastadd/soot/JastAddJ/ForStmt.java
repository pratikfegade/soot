...
if(isDAafter_Variable_values == null) isDAafter_Variable_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean isDAafterInitialization(Variable v) {
    ...
    // Declared in DefiniteAssignment.jrag at line 1097
...
if(isDUafter_Variable_values == null) isDUafter_Variable_values = new java.util.HashMap(4);
    ...
    // Declared in DefiniteAssignment.jrag at line 1117
 @SuppressWarnings({"unchecked", "cast"})     public boolean isDUafterInit(Variable v) {
    ...
    // Declared in DefiniteAssignment.jrag at line 1119
            ...
            if(isFinal && num == state().boundariesCrossed)
{
    ...
    // Declared in DefiniteAssignment.jrag at line 1130
   ...
   int childIndex = caller.getIndexOfChild(child);
{
    ...
    // Declared in DefiniteAssignment.jrag at line 1146
...
public ASTNode rewriteTo() {
    // Declared in DefiniteAssignment.jrag at line 1164
    if(!hasCondition()) {
