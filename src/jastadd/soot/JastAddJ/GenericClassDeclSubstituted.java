...
public class GenericClassDeclSubstituted extends GenericClassDecl implements Cloneable, MemberSubstitutor {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public GenericClassDeclSubstituted fullCopy() {
        GenericClassDeclSubstituted res = copy();
    ...
    // Declared in Generics.ast line 35
    public GenericClassDeclSubstituted(Modifiers p0, jastadd.beaver.Symbol p1, Opt<Access> p2, List<Access> p3, List<BodyDecl> p4, List<TypeVariable> p5, TypeDecl p6) {
        setChild(p0, 0);
        setID(p1);
        setChild(p2, 1);
        setChild(p3, 2);
